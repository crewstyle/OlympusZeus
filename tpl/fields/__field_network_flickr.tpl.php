                                ...
                                <div class="contextual-help-tabs">
                                    ...
                                    <ul>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <li>
                                                <a href="#tea-flickr-recentmedias"><?php _e('Medias') ?></a>
                                            </li>
                                            <li>
                                        ...
                                        <form action="admin.php?page=<?php echo $page ?>&updated=true" method="post" id="tea-flickr-recentmedias" class="help-tab-content">
                                            ...
                                            <ul class="network-recent">
                                                <?php if (empty($user_recent)): ?>
                                                    <li><?php _e('You have no medias in your FlickR account.') ?></li>
                                                <?php else: ?>
                                                    <?php
...
?&gt;</pre>
                                            ...
                                            <?php if (!empty($update)): ?>
                                                <p><small><?php _e('Medias updated on:') ?> <?php echo $update ?></small></p>
                                            <?php endif ?>
                                        </div>
                                    <?php endif ?>
                                </div>
