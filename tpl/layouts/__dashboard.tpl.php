...
$details = array(
    ...
    array(
        ...
        'contents' => array(
            ...
            __('<b>Easier for developers</b> - Create a new admin panel easily with the new dashboard. The Tea TO core is made to allow non-developer profiles to easily create the settings they need to customise their templates.')
        )
    ),
    array(
        'type' => 'hr'
    ...
    array(
        'type' => 'heading',
        'title' => __('How to get values in your Wordpress template?')
    ),
    array(
        'type' => 'p',
        'content' => __('The <b>Tea T.O.</b> allows you to easily get back values and use them into your WordPress theme.<br/>There are 2 ways to get them back.')
    ),
    array(
        'type' => 'list',
        'contents' => array(
            __('<b>Wordpress way</b> - By using the <code>get_option</code> method.'),
            __('<b>Tea T.O. way</b> - Very similar to the Wordpress solution, simply use the <code>_get_option</code> method (pay attention to the first underscore) to get values from Transient API.')
        )
    )
);