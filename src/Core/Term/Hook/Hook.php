...
namespace crewstyle\TeaThemeOptions\Core\Term\Hook;

use crewstyle\TeaThemeOptions\TeaThemeOptions;
use crewstyle\TeaThemeOptions\Core\Field\Field;
use crewstyle\TeaThemeOptions\Core\Term\Engine\Engine;
use crewstyle\TeaThemeOptions\Core\WalkerSingle\WalkerSingle;
...
class Hook
{
    ...
    public function hookColumns($columns)
    {
         ...
         * @since 3.3.0
         */
        return apply_filters('tto_manage_edit-'.$current.'_term_columns', $columns);
    }
    ...
    public function hookCustomColumn($content, $column, $term_id)
    {
         ...
         * @since 3.3.0
         */
        return apply_filters('tto_manage_'.$current.'_term_custom_column', $content, $column, $term_id);
    }
